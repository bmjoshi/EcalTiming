...
parser.add_argument("-j", '--json', type=str, default='json/13TeV_Collisions18_DCSONLY.json')
...
with open('runlist_AlCaPhiSym_Run2018D-v1_RAW.dat','r') as file_:
    runs = [run.strip('\r\n') for run in file_.readlines()]
...
cmsRun test/ecalTime_fromAlcaStream_cfg.py files=${INPUTFILES} globaltag=${GT} outputFile=timing_reco_selections_${RUN}_${JOBID}.root jsonFile={:%s}
